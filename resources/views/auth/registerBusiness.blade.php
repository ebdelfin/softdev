        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('registerBusiness') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('nature') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Business Nature</label>

                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="nature" value="{{ old('nature') }}" required autofocus>
